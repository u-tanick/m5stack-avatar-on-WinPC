...
#ifndef FACES_BBTESTFACE_H_
#define FACES_BBTESTFACE_H_
...
namespace m5avatar
{
    ...
    void draw(M5Canvas *spi, BoundingRect rect, DrawContext *ctx)
    {
      ...
      if(et==0){
        ...
        else
        {
          ...
          spi->fillCircle(x + offsetX, y + offsetY, r*2, primaryColor);
      }
  ...
  /**
    ...
    * 
  */
  class BBEyeblow : public Drawable
  {
  ...
  public:
    BBEyeblow(uint16_t w, uint16_t h, bool isLeft)
    ...
    void draw(M5Canvas *spi, BoundingRect rect, DrawContext *ctx)
    {
      ...
      // eyeblowtype-test-code
      uint16_t ebt = ctx->getEyeBlowType();
      if(ebt==0){
        if (exp == Expression::Neutral || exp == Expression::Sad)
        {
          ...
          spi->fillRect(x, y, 10, 3, primaryColor);
      }
    }
  };
  ...
  */
  ...
  public:
    BBMouth() : BBMouth(0, 0, 0, 0) {}
    BBMouth(uint16_t minWidth, uint16_t maxWidth, uint16_t minHeight,
            uint16_t maxHeight)
        : minWidth{minWidth},
          maxWidth{maxWidth},
          minHeight{minHeight},
    ...
    void draw(M5Canvas *spi, BoundingRect rect, DrawContext *ctx)
    {
      ...
      if(mt==0){
        ...
        spi->fillRect(x, y, 10, 30, primaryColor);
      }
    }
  };
  ...
  */
  class BBFace : public Face
  {
  public:
    BBFace()
        : Face(new BBMouth(), new BoundingRect(74, 136),
               new BBEye(8, false), new BoundingRect(93, 90),
               new BBEye(8, true), new BoundingRect(96, 230),
               new BBEyeblow(18, 3, false), new BoundingRect(71, 50),
               new BBEyeblow(18, 3, true), new BoundingRect(73, 270)) {}
  };

} // namespace m5avatar

#endif // FACES_BBTESTFACE_H_
